# Protocol 19: The Vibe Coding System (System-Assisted Building)
...
_Context Lock_: Keep this in the chat history. This prevents "drift" later.
...
**Critical Step**: Do not write feature code. Write the _Plan_.
...
1. Feed the _entire_ Workplan to the model.
...
4. **Iteration**:
   - _Small fixes_: Fast Model (Opus 4.5/Gemini 3 Flash).
   - _Architectural changes_: Reasoning Model (Opus/Gemini Pro/o1).
