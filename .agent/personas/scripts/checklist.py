...
Usage:
    python .agent/personas/scripts/checklist.py .                    # Run core checks
    python .agent/personas/scripts/checklist.py . --url <URL>        # Include performance checks
...
CORE_CHECKS = [
    ("Security Scan", ".agent/skills/securing-code/vulnerability-scanner/scripts/security_scan.py", True),
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python .agent/personas/scripts/checklist.py .                      # Core checks only
  python .agent/personas/scripts/checklist.py . --url http://localhost:3000  # Include performance
        """
    )
